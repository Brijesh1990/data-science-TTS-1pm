...
6) Write a program to calculate the area of a rectangle using variables.

7) Declare a constant value of PI and calculate the area of a circle.
...
18) Write a program to concatenate two strings using variables.

19) Store employee name, ID, and salary and display them.

20) Write a program to show the difference between local and global variables.

21) Write a program to demonstrate arithmetic operators.
...
39) Write a program to check eligibility for voting using operators.

40) Write a program to evaluate a mathematical expression using operators.

41) Write a function to print “Hello Python”.


42) Write a function to add two numbers.
...
51) Write a function to calculate area of a circle.


52) Write a function to convert Celsius to Fahrenheit.


53) Write a function to find sum of digits of a number.
...
56) Write a function to check whether a number is Armstrong.


57) Write a function to calculate average of numbers.


58) Write a recursive function to find factorial.


59) Write a recursive function to generate Fibonacci series.


60) Write a function to check even or odd.


61) Write a function that returns multiple values.


62) Write a lambda function to add two numbers.


63) Write a function to find minimum and maximum from a list.


64) Write a function to check if a string is palindrome.
...
🔹 PART B: TKINTER (GUI PROGRAMMING) (71–100)


72) Create a simple Tkinter window.


73) Write a Tkinter program to display a label.


74) Create a button in Tkinter and display a message on click.


75) Write a Tkinter program to accept input using Entry widget.


76) Create a Tkinter program to add two numbers using GUI.


77) Write a Tkinter program to change label text on button click.


78) Create a GUI calculator using Tkinter.


79) Write a Tkinter program to change background color.
...
83) Write a Tkinter program using CheckButtons.


84) Create a Tkinter program to display a message box.


85) Write a Tkinter program to clear input fields.


86) Create a login form using Tkinter.


87) Write a Tkinter program using ListBox.


88) Create a Tkinter program to select items from a list.


89) Write a Tkinter program to display current date and time.


90) Create a Tkinter program to perform arithmetic operations.


91) Write a Tkinter program using Menu widget.


92) Create a Tkinter program using Frame widget.


93) Write a Tkinter program to resize window dynamically.


94) Create a Tkinter program to validate user input.


95) Write a Tkinter program to exit application using button.


96) Create a Tkinter program to change font style.


97) Write a Tkinter program to open a new window.


98) Create a Tkinter program to show password field.


99) Write a Tkinter program to count button clicks.


100) Create a Tkinter program for simple registration form.


101) Write a Tkinter program to display a digital counter.
